...
structure(list(xlog = FALSE, ylog = FALSE, adj = 0.5, ann = TRUE, 
    ...
    fig = c(0, 1, 0, 1), fin = c(11.1929133858268, 7.76771653543307
    ...
    0), pch = 1L, pin = c(9.95291338582677, 5.92771653543307), 
    plt = c(0.0732606401688357, 0.962476257474499, 0.131312721743538, 
    0.894434870755195), ps = 12L, pty = "m", smo = 1, srt = 0, 
    tck = NA_real_, tcl = -0.5, usr = c(0, 1, 0, 1), xaxp = c(0, 
...
"ljoin", "lmitre", "lty", "lwd", "mai", "mar", "mex", "mfcol", 
"mfg", "mfrow", "mgp", "mkh", "new", "oma", "omd", "omi", "pch", 
"pin", "plt", "ps", "pty", "smo", "srt", "tck", "tcl", "usr", 
